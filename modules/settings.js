...
const DEFAULT_SETTINGS = {
  ...
  rememberLastProvider: true,  // When true, AIChatMerge opens last selected provider; when false, always opens default provider
  theme: 'auto',
  language: null,
  ...
  debugAutoDownloadLogs: false, // 正式版：调试日志自动下载功能已剔除，此设置无实际作用
  // Markdown 导出设置
