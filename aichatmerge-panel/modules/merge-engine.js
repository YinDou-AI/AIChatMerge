...
import { autoExportToMarkdown as defaultAutoExportToMarkdown } from './markdown-export.js';
import {
  beginMergeSession,
...
async function runTriggerMerge({ panels, mergePanelIds, autoExportToMarkdown = defaultAutoExportToMarkdown }) {
