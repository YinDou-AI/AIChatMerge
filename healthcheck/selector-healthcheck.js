...
const PROVIDERS = {
  ...
  wenxin: {
    ...
    inputSelectors: ['div[data-slate-editor="true"]', 'textarea[placeholder*="输入"]', 'textarea'],
    sendButtonSelectors: ['button[aria-label="发送"]', 'button[aria-label="Send"]', 'button[type="submit"]'],
  ...
  grok: {
    url: 'https://grok.com/',
    inputSelectors: ['.tiptap', '.ProseMirror', 'textarea'],
